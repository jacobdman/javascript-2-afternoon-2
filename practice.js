...
function divider (numbersArray) {
  var evensArray = []
  var oddsArray = []
  var dividedArray = [evensArray,oddsArray]
...
var user2 = {
  name: 'Bagbo Billbins',
  email: 'Adventure@theshire.org',
  password: 'T4k3nT0Is3ng4rd',
  username: 'Except4PartyGuests'
}

var user3 = {
  name: 'Lanakin Lywalker',
  email: 'IKilledThem@LikeAnimals.com',
  password: 'NotJustTheMen',
  username: 'ButtheWomenandChildrentoo'
}
